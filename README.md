...
A detailed vignette demonstrating the application of **TESSERA** to multi-sample spatial transcriptomics data is available as a [rendered HTML article](https://floricaconstantine.github.io/TESSERA/articles/vignette.html). 
